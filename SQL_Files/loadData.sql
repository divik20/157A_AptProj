...
LOAD DATA INFILE 'C:\\xampp\\htdocs\\BlueSwift\\SQL_Files\\Tenant.csv' INTO TABLE Apartment FIELDS TERMINATED BY ',';
LOAD DATA INFILE 'C:\\xampp\\htdocs\\BlueSwift\\SQL_Files\\TenantHasSuite.csv' INTO TABLE Apartment FIELDS TERMINATED BY ',';
